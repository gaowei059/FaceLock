...
public class DetectActivity extends Activity implements OnCameraListener, View.OnTouchListener, Camera.AutoFocusCallback {
	...
	class FRAbsLoop extends AbsLoop {
		...
		List<FaceDB.FaceRegist> mResgist = ((Application)DetectActivity.this.getApplicationContext()).mFaceDB.mRegister;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mGLSurfaceView = (CameraGLSurfaceView) findViewById(R.id.glsurfaceView01);
		mGLSurfaceView.setOnTouchListener(this);
		mSurfaceView = (CameraSurfaceView) findViewById(R.id.surfaceView01);
