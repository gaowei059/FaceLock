...
import com.arcsoft.sdk_demo.util.DateFormat;

import java.util.Date;

public class ThemeGraphTime extends LinearLayout implements ILockView{
    ...
    public ThemeGraphTime(Context context) {
        super(context);
    ...
    public ThemeGraphTime(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
