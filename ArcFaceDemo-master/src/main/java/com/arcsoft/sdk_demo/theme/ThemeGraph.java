...
import com.arcsoft.sdk_demo.util.Global;
...
public class ThemeGraph extends FrameLayout implements ILockView{
    ...
    private void drawCircle(Canvas canvas){
        ...
        for(int i = 0 ; i < mPointFs.length ;i++){
            int sColor_BigCircle_normal = 0xFFFFFFFF;
            int sColor_BigCircle_press = 0xfff7d0ba;
            if(isPressed(i))
            ...
            int sColor_SmallCircle_normal = 0xFF000000;
            int sColor_SmallCircle_press = 0xffffdab9;
            if(isPressed(i))
